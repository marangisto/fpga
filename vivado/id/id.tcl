...
#
#    "C:/Users/marten/Projects/fpga/vivado/id/id.srcs/sources_1/new/main.v"
#    "C:/Users/marten/Projects/fpga/vivado/id/id.srcs/constrs_1/imports/digilent-xdc-master/Nexys-A7-50T-Master.xdc"
#
...
if {[string equal [get_runs -quiet synth_1_copy_1] ""]} {
    create_run -name synth_1_copy_1 -part xc7k70tfbv676-1 -flow {Vivado Synthesis 2021} -strategy "Vivado Synthesis Defaults" -report_strategy {No Reports} -constrset constrs_1
} else {
